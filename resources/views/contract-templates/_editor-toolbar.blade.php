{{-- Formatting toolbar — intended for use inside a parent x-data="tiptapEditor()" scope --}}

{{-- Headings --}}
<button type="button" @click="toggleH2()"
    :class="isActive('heading',{level:2}) ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
    class="px-2 py-1 text-xs font-bold rounded transition-colors">H2</button>
<button type="button" @click="toggleH3()"
    :class="isActive('heading',{level:3}) ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
...
<button type="button" @click="toggleBold()"
    :class="isActive('bold') ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
    class="px-2 py-1 text-xs font-bold rounded transition-colors">B</button>
<button type="button" @click="toggleItalic()"
    :class="isActive('italic') ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
    class="px-2 py-1 text-xs italic rounded transition-colors">I</button>
<button type="button" @click="toggleUnderline()"
    :class="isActive('underline') ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
...
<button type="button" @click="alignLeft()"
    :class="isActive({textAlign:'left'}) ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
    class="px-2 py-1 rounded transition-colors" title="左揃え">
...
<button type="button" @click="alignCenter()"
    :class="isActive({textAlign:'center'}) ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
    class="px-2 py-1 rounded transition-colors" title="中央揃え">
...
<button type="button" @click="alignRight()"
    :class="isActive({textAlign:'right'}) ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
    class="px-2 py-1 rounded transition-colors" title="右揃え">
...
<button type="button" @click="toggleBullet()"
    :class="isActive('bulletList') ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
    class="px-2 py-1 text-xs rounded transition-colors">• リスト</button>
<button type="button" @click="toggleOrdered()"
    :class="isActive('orderedList') ? 'bg-gray-200 text-gray-900' : 'text-gray-500 hover:bg-gray-100'"
...
<button type="button" @click="outdent()"
    class="px-2 py-1 rounded text-gray-500 hover:bg-gray-100 transition-colors" title="インデント減（Shift+Tab）">
...
<button type="button" @click="indent()"
    class="px-2 py-1 rounded text-gray-500 hover:bg-gray-100 transition-colors" title="インデント増（Tab）">
...
<button type="button" @click="insertHr()"
    class="px-2 py-1 text-xs rounded text-gray-500 hover:bg-gray-100 transition-colors" title="区切り線">——</button>

<span class="w-px h-4 bg-gray-200 mx-1"></span>

<button type="button" @click="clearFormat()"
    class="px-2 py-1 text-xs rounded text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors">書式解除</button>
