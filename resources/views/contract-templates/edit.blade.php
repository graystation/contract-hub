            ...
            <div class="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
                ...
                <div class="max-w-4xl mx-auto px-6 h-12 flex items-center justify-between gap-4">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <span class="text-sm text-gray-700 font-medium truncate">{{ $template->title }}</span>
                    </div>
            ...
            <div class="max-w-4xl mx-auto w-full px-6 py-10 space-y-8 flex-1">
                ...
                <div>
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden
                        ...
                        <textarea name="body" data-tiptap-value class="hidden">{{ old('body', $template->body ?? '') }}</textarea>
                    </div>
