...
>
    <form method="POST" action="{{ route('contracts.store') }}" class="flex flex-col flex-1">
        @csrf
            ...
            <div class="max-w-5xl mx-auto px-6 h-12 flex items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <a href="{{ route('contracts.index') }}"
                       class="text-sm text-gray-400 hover:text-gray-700 shrink-0">← 一覧</a>
                    <span class="text-gray-200 shrink-0">|</span>
                    <span class="text-sm text-gray-500">新規契約</span>
                </div>
            ...
            <div x-data="contractForm({
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="notes" rows="2"
                              class="block w-full border-0 border-b border-gray-200 focus:border-indigo-400 focus:ring-0 text-sm text-gray-900 bg-transparent py-1.5 resize-none">{{ old('notes') }}</textarea>
                </div>
                ...
                <div class="col-span-2 pt-2">
                    <a href="{{ route('contract-templates.create') }}" target="_blank"
                       class="text-xs text-indigo-600 hover:text-indigo-800">+ テンプレートを作成</a>
                </div>
                @endif
